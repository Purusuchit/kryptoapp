...
class DetailsFragment : Fragment() {
    ...
    private fun setButtonOnClick(item: CryptoCurrency) {
        ...
        val clickListener = View.OnClickListener {
            ...
            when(it.id){
                ...
                fifteenMinute.id -> loadChartData(it, "15", item, oneMonth, oneWeek, oneDay, fourHour, oneHour )
                oneHour.id -> loadChartData(it, "1H", item, oneMonth, oneWeek, oneDay, fourHour, fifteenMinute )
                fourHour.id -> loadChartData(it, "4H", item, oneMonth, oneWeek, oneDay, fifteenMinute, oneHour )
                oneDay.id -> loadChartData(it, "D", item, oneMonth, oneWeek, fifteenMinute, fourHour, oneHour )
                oneWeek.id -> loadChartData(it, "W", item, oneMonth, fifteenMinute, oneDay, fourHour, oneHour )
                oneMonth.id -> loadChartData(it, "M", item, fifteenMinute, oneWeek, oneDay, fourHour, oneHour )
    ...
    private fun loadChartData(
        ...
        disableButton(oneMonth, oneWeek, oneDay, fourHour, oneHour)
    ...
    private fun disableButton(oneMonth: AppCompatButton, oneWeek: AppCompatButton, oneDay: AppCompatButton, fourHour: AppCompatButton, oneHour: AppCompatButton) {
